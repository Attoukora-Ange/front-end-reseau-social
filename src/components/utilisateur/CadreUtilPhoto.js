  ...
  return (
    <div className="profil_utilisateur_photo">
      <div className="image_couvrture">
        <img  src= {user.photo_couverture ? `/assets/images/couverture/${user.photo_couverture}` : COUVERTURE} alt="utilisateur couverture" />
      </div>
      <div className="image_profil">
        <img  src= {user.photo_profil ? `/assets/images/profil/${user.photo_profil}` : LOGIN}  alt="utilisateur profil" />
      </div>
    </div>
  );
};
